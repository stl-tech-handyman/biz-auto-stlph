  ...
  <body style="margin:0; padding:0; font-family: Arial, Helvetica, sans-serif; background-color: #ffffff; color: #333333;">
    <table width="100%%" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; width: 100%%;">
      <tr>
          ...
          <table width="100%%" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; border: 1px solid #cccccc; padding: 12px; background-color: #ffffff;">
            ...
            <tr>
              <td align="center" style="padding-bottom: 3px;">
                <img src="https://stlpartyhelpers.com/wp-content/uploads/2025/08/stlph-logo-2.jpg" alt="STL Party Helpers - Professional Event Staffing Services in St. Louis" style="max-width: 60px; height: auto;" />
              </td>
            </tr>
            ...
            <tr>
              <td align="center" style="padding-bottom: 8px; font-size: 14px; line-height: 1.5;">
            ...
            <tr>
              <td align="center" style="padding: 4px 0 5px 0;">
                ...
                <p style="font-size: 13.5px; color: #666666; padding-top: 8px; padding-bottom: 0; margin: 0; text-align: center; font-style: italic;">
                  %s is your event start time. We recommend booking 30 minutes to 1 hour earlier to have enough time for prep work and walk-through. Depending on the amount of prep work, it could take longer. If you're unsure, you can always call us or schedule time for us to call you at your convenience.
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td align="center" style="padding-top: 4px;">
                <table width="540" cellpadding="5" cellspacing="0" border="0" style="background-color: #f9f9f9; width: 540px;">
                  <tr>
                    <td style="font-weight: bold; font-size: 14px; padding: 5px; width: 50%%;">Base Rate:</td>
                    <td style="font-size: 14px; padding: 5px; width: 50%%;">%s / helper (first 4 hours)</td>
                  </tr>
                  <tr>
                    <td style="font-weight: bold; font-size: 14px; padding: 5px; width: 50%%;">Additional Hours:</td>
                    <td style="font-size: 14px; padding: 5px; width: 50%%;">%s per hour per helper</td>
                  </tr>
                  <tr>
                ...
                <p style="font-size: 12.5px; color: #666666; padding-top: 8px; padding-bottom: 0; margin: 0; text-align: center;">
            ...
            <tr>
              <td style="background-color: #f0f0f7; padding: 10px; margin-top: 8px; border-left: 5px solid rgb(38, 37, 120); border-top: 1px solid #e0e0e0; text-align: center;">
                ...
                <p style="margin: 8px 0 0 0; font-size: 12.5px; color: #666666;">100%% refund if cancelled 3+ days before the event.</p>
              </td>
            </tr>

            <!-- Want us to call you? -->
            <tr>
              <td style="font-size: 16px; font-weight: bold; padding-top: 10px; padding-bottom: 6px; border-top: 1px solid #e0e0e0; text-align: center;">Want us to call you?</td>
            </tr>
            <tr>
              <td style="padding: 4px 0 5px 0; font-size: 14px; line-height: 1.5; text-align: center;">
                <p style="margin: 0;">Have a question or want to double-check details?</p>
                <p style="margin: 4px 0 8px 0;">We're happy to give you a quick call and walk through everything together.</p>
                <p style="margin: 8px 0; text-align: center;">
                  <a href="%s" style="display: inline-block; background-color: rgb(38, 37, 120); color: #ffffff; padding: 8px 16px; text-decoration: none; font-weight: bold; font-size: 14.5px; border-radius: 4px;">Request a Quick Call</a>
                </p>
                <p style="margin: 8px 0 0 0; font-size: 12.5px; color: #666666;">No pressure — just clarity.</p>
                <p style="margin: 8px 0 0 0; font-size: 12.5px; color: #666666;">If your event is similar to a past booking, you don't need a call.</p>
                <p style="margin: 4px 0 0 0; font-size: 12.5px; color: #666666;">If anything feels unclear — timing, helpers, setup, or pricing — a quick call can help.</p>
                <p style="margin: 6px 0 0 0; font-size: 11.5px; color: #999999;">We'll call you at the time you choose.</p>
              </td>
            </tr>
            <tr>
              <td style="padding: 8px 0 5px 0; font-size: 14px; line-height: 1.5; text-align: center;">
                <p style="margin: 0;">Need something specific or a small adjustment?</p>
                <p style="margin: 4px 0 0 0;">Just let us know — we'll do our best to accommodate.</p>
              </td>
            </tr>

            <!-- Footer -->
            <tr>
              <td align="center" style="font-size: 12.5px; padding-top: 10px; color: #666666; line-height: 1.5;">
		...
		data.EventTime,                // Staff arrival time reference: %s
